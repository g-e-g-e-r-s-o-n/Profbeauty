            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <form action="{{ route('suggestion-add') }}" method="POST" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    {{--                                    {{ method_field('') }}--}}

                                    <div class="form-group">
                                        <label>სათაური</label>
                                        <input type="text" name="suggestion_title" class="form-control blue" maxlength="200" required>
                                    </div>
                                    {{--                                    <div class="form-group">--}}
                                    <label>ტექსტი</label>
                                    <textarea name="suggestion_text" class="form-control blue" maxlength="255" required></textarea>
                                    {{--                                    </div>--}}
                                    {{--                                    <div class="form-group">--}}
                                    <label>ბოლო ვადა</label>
                                    <input type="datetime-local" name="suggestion_deadline" class="form-control blue" required>
                                    {{--                                    </div>--}}

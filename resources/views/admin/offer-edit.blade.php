            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <form action="/offer-update/{{ $offers->id }}" method="POST">
                                    @csrf
                                    {{ method_field('PUT') }}
                                    ...
                                    <label>ტექსტი</label>
                                    <textarea name="offer_text" class="form-control blue" maxlength="255" required>{{ $offers->offer_text }}</textarea>
                                    {{--                                    </div>--}}
                                    <div class="form-group">
                                        <label>ბმული</label>
                                        <input type="text" name="offer_url" class="form-control blue" value="{{ $offers->offer_url }}" maxlength="200" required>
                                    </div>
                                    {{--                                    <div class="form-group">--}}
                                    <label>ფოტო</label>
                                    <input type="file" name="offer_image" class="form-control blue" value="{{ $offers->offer_image }}" required>
                                    {{--                                    </div>--}}

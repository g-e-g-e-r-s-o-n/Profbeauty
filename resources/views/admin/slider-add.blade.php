...
@section('title')
    პროფბიუთი - სამართავი პანელი | სლაიდერის დამატება
@endsection
...
@section('page-title')
    სამართავი პანელი - სლაიდერის დამატება
@endsection
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form action="{{ route('slider-add') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <label>ტექსტი</label>
                                    <textarea name="slider_text" class="form-control blue" maxlength="255" required></textarea>
                                    {{--                                    </div>--}}
                                    <div class="form-group">
                                        <label>ბმული</label>
                                        <input type="text" name="slider_url" class="form-control blue" maxlength="200" required>
                                    </div>
                                    {{--                                    <div class="form-group">--}}
                                    <label>ფოტო</label>
                                    <input type="file" name="slider_image" class="form-control blue" required>
                                    {{--                                    </div>--}}
